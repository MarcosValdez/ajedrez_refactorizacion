...
public class ChessGameEngine implements Serializable {
    ...
    // ----------------------------------------------------------
    /**
     * Create a new piesas.ChessGameEngine object. Accepts a fully-created
     * piesas.ChessGameBoard. (i.e. all components rendered)
     *
     * @param board
     *            the reference piesas.ChessGameBoard
     */
