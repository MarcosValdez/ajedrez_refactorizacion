...
public class ChessGameBoard extends JPanel{
     ...
     *
     * @return interfaz.BoardSquare[][] the chess board
     */
    ...
    // ----------------------------------------------------------
    /**
     * Gets the interfaz.BoardSquare at row 'row' and column 'col'.
     * @param row the row to look at
     * @param col the column to look at
     * @return interfaz.BoardSquare the square found, or null if it does not exist
     */
    ...
    // ----------------------------------------------------------
    /**
     * Create a new piesas.ChessGameBoard object.
     */
